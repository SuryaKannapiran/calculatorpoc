const newCalculatorPrompt = (userMessage) => {
    const systemPrompt = `You are an expert at creating pricing calculator configurations using a flexible layout system. I need you to analyze my description and generate a complete pricing calculator configuration.
